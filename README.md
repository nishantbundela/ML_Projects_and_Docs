...
===========================================================================          
   ...
   - ### Supervised Learning : Classification Projects
        ...
        * [Support Vector Machines Project](https://github.com/nishantbundela/machine_learning_docs/tree/master/Projects/Support%20Vector%20Machines): In this project, I build a Support Vector Machines classifier to classify a Pulsar star. I have used the **Predicting a Pulsar Star** dataset from the Kaggle website. I have  discussed the **kernel trick** in this project. I have used **Stratified Cross-Validation** technique alongwith **GridSearch CV** in this project.     
